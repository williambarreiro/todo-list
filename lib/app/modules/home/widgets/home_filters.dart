          ...
          child: Row(
            children: [
              TodoCardFilter(
                ...
                totalTasksModel:
                    TotalTasksModel(totalTasks: 10, totalTasksFinished: 4),
              ...
              TodoCardFilter(
                ...
                totalTasksModel:
                    TotalTasksModel(totalTasks: 30, totalTasksFinished: 10),
                selected: context.select<HomeController, bool>(
              ...
              TodoCardFilter(
                ...
                totalTasksModel:
                    TotalTasksModel(totalTasks: 10, totalTasksFinished: 9),
                selected: context.select<HomeController, bool>(
